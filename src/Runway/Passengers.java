...
public class Passengers implements Runnable {
    ...
    public void run(){
        synchronized (planeOps.PassengerLock) {
            ...
            System.out.println(Thread.currentThread().getName() + ": Passengers Disembark from the plane: " + rec.getSpecificPlane(index));
            ...
            System.out.println(Thread.currentThread().getName() + ": Passengers embark to the plane: " + rec.getSpecificPlane(index));
